<template>
  <div id="placeholderSignup">
    ...
    <div class="user-already-exist" v-if="userAlreadyExist">
      ...
      <form @submit.prevent="onSubmit">
        <div class="form-input">
          ...
          <p v-if="lastnameError" class="error">
            Le nom est incorrect veuillez ne saisir que des lettres
          </p>
        ...
        <div class="form-input">
          ...
          <p v-if="firstnameError" class="error">
            Le prenom est incorrect veuillez ne saisir que des lettres
          </p>
          <input
            type="text"
            name="prenom"
        ...
        <div class="form-input">
          ...
          <p v-if="passwordError" class="error">
            8 caractère minimum, dont 1 majuscule, 1 minuscule, 1 chiffre et un
            caractère special
          </p>
          <input
            type="password"
        ...
        <button id="signup-button" type="submit" v-if="!userAlreadyExist">
          S'inscrire
        </button>
      </form>
    </div>
...
export default {
  ...
  methods: {
    ...
    createUser: async function () {
      try {
        // fonction qui envoie la requete avec axios, sur la route signup. avec les information récupéré dans les champs des formulaires
